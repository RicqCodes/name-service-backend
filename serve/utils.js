...
exports.encodeSVGToBase64 = exports.generateMetadata = exports.generateSVG = void 0;
...
const generateSVG = (domainName) => {
    return svgPartOne + domainName + svgPartTwo;
};
exports.generateSVG = generateSVG;
const generateMetadata = (id, domainName, svg) => {
    const json = {
        tokenId: id,
        name: domainName,
        description: "A domain on the test name service",
        image: "data:image/svg+xml;base64," + (0, exports.encodeSVGToBase64)(svg),
    };
...
// async function postMetadataToBackend(metadata) {
//   try {
//     const response = await axios.post("YOUR_BACKEND_API_URL", { metadata });
//     console.log("Metadata posted to backend:", response.data);
//   } catch (error) {
//     console.error("Error posting metadata to backend:", error.message);
//   }
// }
